...
from . import timing, variables as v

FIELDS_SEASON = [
    'art', 'playcount', 'season', 'showtitle', 'episode', 'tvshowid',
    'watchedepisodes', 'userrating', 'fanart', 'thumbnail'
]
...
def item_details(kodi_id, kodi_type):
    '''
    Returns the Kodi dict for this item
    '''
